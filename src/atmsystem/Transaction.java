...
public class Transaction extends Frame implements ActionListener{
   ...
   public static  String search;
    ...
    Transaction(){
        ...
        lbl_title = new JLabel("Please Selected Button");
        ...
        btn_chk.setFont(new Font("Algerian",Font.PLAIN,18));
        add(btn_chk);
        ...
        btn_wid.setFont(new Font("Algerian",Font.PLAIN,18));
        add(btn_wid);
        
        btn_dep = new Button("Deposite");
        btn_dep.setBounds(50, 300, 150, 35);
        btn_dep.setBackground(Color.ORANGE);
        btn_dep.setForeground(Color.DARK_GRAY);
        btn_dep.setFont(new Font("Algerian",Font.PLAIN,18));
        add(btn_dep);
        ...
        btn_log.setFont(new Font("Algerian",Font.PLAIN,18));
        add(btn_log);
    ...
    public void actionPerformed(ActionEvent e){
      ...
      try{
          ...
          ResultSet rs = st.executeQuery("SELECT * FROM info WHERE Account = '" + search+"'");
            ...
            str_dep = JOptionPane.showInputDialog(null,"Enter Amount","Deposite",JOptionPane.PLAIN_MESSAGE);
         ...
         if(btn_wid==e.getSource()){
          ...
          ResultSet rs = st.executeQuery("SELECT * FROM info WHERE Account = '" + search+"'");
                ...
                mainblnc = Integer.parseInt(lbl_bal.getText());
                str_with = JOptionPane.showInputDialog(null,"Enter Amount","Deposite",JOptionPane.PLAIN_MESSAGE);
                ...
                if(mainblnc<withdraw){
                    ...
                    JOptionPane.showMessageDialog(null, "You have Withdrawed : "+ str_with,"Message",JOptionPane.INFORMATION_MESSAGE);
