...
public class Login extends Frame implements ActionListener{
    ...
    Login(){
            ...
            t1.setFont(new Font("Comic Sans MS",Font.PLAIN,16));
            ...
            b3.setFont(new Font("Comic Sans MS",Font.PLAIN,18));
    ...
    public void paint(Graphics g){
        ...
        g.setFont(new Font("Lucida Handwriting",Font.PLAIN,26));
        g.drawString("Login Form", 100, 80);
        
        g.setColor(Color.red);
        g.setFont(new Font("Algerian",Font.PLAIN,22));
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(e.getSource()==b1){
          ...
          try{
              ...
              ResultSet rs=null;
                rs = st.executeQuery("select * from info where Account='" +t1.getText()+"' AND Password='"+t2.getText()+"'");
